...
const Header: React.FC = () => {
            ...
            <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
              {menuItems.map((item) => (
                <a
                  ...
                  className={`block px-4 py-3 text-sm font-medium transition-all duration-300 border-b border-gray-100 dark:border-gray-700 last:border-b-0 ${
              ...
              <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-700/50">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="px-2 py-1 text-xs font-medium text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition-colors border border-gray-300 dark:border-gray-600 rounded"
  ...
  return (
    <header className="fixed top-0 w-full z-50 bg-gray-900 dark:bg-gray-950 space-header backdrop-blur-sm shadow-lg transition-colors duration-300">
      <nav className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6 relative z-10">
        <div className="flex justify-between items-center py-2">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button
              onClick={() => setLanguage(language === 'en' ? 'pl' : 'en')}
              className="px-3 py-1.5 text-sm font-medium text-white hover:text-blue-400 transition-colors border border-white/20 rounded-lg hover:bg-white/10 flex items-center gap-1"
              aria-label="Switch language"
            >
              <Globe size={16} />
              {language === 'en' ? 'PL' : 'EN'}
